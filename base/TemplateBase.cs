...
namespace Tridion.Extensions.ContentManager.Templating
{
	public abstract class TemplateBase : global::Tridion.ContentManager.Templating.Assembly.ITemplate, global::System.IDisposable
	{
		...
		protected IList<StructureGroup> GetStructureGroups()
		{
			...
			return GetObjectsFromXmlList<StructureGroup>(m_Engine, publication.GetListOrganizationalItems(sgFilter));
		}
		...
		/// <summary>
		/// Returns an XML element describing the entire navigation structure of the publication on which this 
		/// template is invoked.
		/// </summary>
		...
		/// <param name="rootSG">the structure group from which to start building the navigation</param>
		/// <param name="SGs">the list of all structure groups in the publication, as retrieved from GetListStructureGroups</param>
		/// <param name="doc">the element to use for creating the new XML elements. If null, a new element will be created</param>
		/// <param name="parent">the element to append the new XML elements to. If null, the element(s) will be appended to the element.</param>
		/// <param name="regex">the regex that items must match to be included in the menu</param>
		/// <returns>an XML element describing the entire navigation structure of the publication on which this 
		/// template is invoked</returns>
